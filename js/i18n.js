...
window.PBCRUN_I18N = (function () {
    ...
    return Object.assign(
      {
        ...
        headline_to: "to",
        headline_place: "Pebble Beach Car Week",
        days: "Days",
        hours: "Hours",
        mins: "Mins",
        secs: "Secs",
        ...
        enter_title: "Enter",
        code_label: "Enter invitation code",
        code_ph: "Your code",
        enter_cta: "Enter",
        enter_hint: "Use the email and code from your invitation.",
        need_invite: "Don’t have a code? Request an invitation",
        have_code: "Already have a code? Enter here",
        err_code: "Please enter your invitation code.",
        err_code_invalid: "That invitation code is not valid.",
        ...
        success_msg: "Thanks — we will respond shortly.",
        footer: "PBCRun · Independent guide to Monterey Car Week",
        privacy_link: "Privacy Policy",
        err_email: "Please enter a valid email address.",
        err_consent: "Please agree and review the Privacy Policy so we can email your invitation.",
        sending: "Sending…",
        entering: "Checking code…",
  ...
  var privacyEn = {
    privacy_intro:
      "This Privacy Policy describes how PBCRun (“PBCRun,” “we,” “us,” or “our”) collects, uses, discloses, and protects personal information when you use pbcrun.com, related pages, and our invitation waitlist (the “Services”). PBCRun is an independent guide to Monterey Car Week and related events in the Monterey Peninsula area.",
    ...
    Object.assign(
      {
        ...
        success_msg: "Grazie — risponderemo a breve.",
        footer: "PBCRun · Guida indipendente alla Monterey Car Week",
  ...
  T.de = pack(
    {
      ...
      success_msg: "Danke — wir melden uns in Kürze.",
      footer: "PBCRun · Unabhängiger Guide zur Monterey Car Week",
  ...
  T.fr = pack(
    {
      ...
      success_msg: "Merci — nous répondrons sous peu.",
      footer: "PBCRun · Guide indépendant de la Monterey Car Week",
  ...
  T.es = pack(
    {
      ...
      success_msg: "Gracias — responderemos en breve.",
      footer: "PBCRun · Guía independiente de la Monterey Car Week",
  ...
  T.ru = pack(
    {
      ...
      success_msg: "Спасибо — мы ответим в ближайшее время.",
      footer: "PBCRun · Независимый гид по Monterey Car Week",
  ...
  T.ar = pack(
    {
      ...
      success_msg: "شكرًا — سنرد قريبًا.",
      footer: "PBCRun · دليل مستقل لأسبوع سيارات مونتيري",
  ...
  T.ja = pack(
    {
      ...
      success_msg: "ありがとうございます。まもなくご連絡します。",
      footer: "PBCRun · モントレー・カーウィークのインディペンデント・ガイド",
      privacy_link: "プライバシー",
  ...
  T.ko = pack(
    {
      ...
      success_msg: "감사합니다 — 곧 답변드리겠습니다.",
      footer: "PBCRun · 몬터레이 카 위크 독립 가이드",
      privacy_link: "개인정보",
  ...
  T.zh = pack(
    {
      ...
      success_msg: "谢谢 — 我们会尽快回复。",
      footer: "PBCRun · 蒙特雷汽车周独立指南",
      privacy_link: "隐私政策",
